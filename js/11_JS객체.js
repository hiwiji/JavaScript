...
document.getElementById("btn2").addEventListener("click", function() {
    ...
    for(let std of stdList) {
        ...
        for(let key in std) {
            ...
            // std는 학생하나하나 (new Student)
            //key는 홍길동이라는 객체를 한바퀴 돌면서: grade: 1 / ban:2 / name: 홍길동 /
            
            // std[key] == std.key
            // std[grade] == typeof -> string
            // std[ban] == typeof -> string
            // std[name]
            // std[introduce] == typeof -> function이라 위에 
        }
        div2.innerHTML += "<hr>";
    }
