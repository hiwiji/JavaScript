...
document.getElementById("check1").addEventListener("click", function() {
    ...
    // console.log("regEx1.test(str1) : " + "script".test("저희는 지금 javascript를 공부하고 있습니다.")
    ...
    // 정규표현식에서 str1에 java 있어서 ture
    console.log("regEx2.exec(str1) : " + regEx2.exec(str1));
    // 정규표현식에서 str1에 java 있어서 java 출력
    ...
    //str3의 경우 java라는 문자열 포함되는게 3개 있지만
    //exec는 첫번째 문자열만 추출해와서 java라고 표현이 됨.
    // 그래서 java라는게 모두 표현된걸 확인하고 싶으면, 위와 같이 단독으로 콘솔에 써주면 됨

    // 결과값 : 'java', index: 6, input: 'aaaaaajava, java, java', groups: undefined
})
